...
import { orange,lightGreen,green,deepPurple } from '@material-ui/core/colors';
...
class CheckboxTree extends React.Component {
    ...
    static defaultProps = {
        ...
        expanded: [],
        icons:{
            check: <CheckBoxIcon style={{ color: green[500] }}/>,
            uncheck: <CheckBoxOutlineBlankIcon/>,
            halfCheck:<IndeterminateCheckBoxIcon style={{ color: orange[500] }} />,
            expandClose:<NavigateNextIcon/>,
            expandOpen:<ExpandMoreIcon/>,
            expandAll:<ZoomInIcon/>,
            collapseAll:<ZoomOutIcon/>,
            parentClose:<DnsIcon color="secondary" />,
            parentOpen:<DnsIcon color="secondary"/>,
            leaf:<PlayCircleFilledIcon style={{ color: deepPurple[500] }}/>
        },
        iconsClass: 'fa5',
        id: null,
        lang: {
